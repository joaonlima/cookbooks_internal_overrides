...
attribute "cassandra/partitioner",
  :description  => "The partitioner to be used on the cluster (Murmur3Partitioner, RandomPartitioner, ByteOrderedPartitioner, OrderPreservingPartitioner (deprecated))",
  :recipes      => ["cassandra::configure"],
  :type         => "string",
